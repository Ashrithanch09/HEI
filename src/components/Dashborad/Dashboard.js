...
<p className='line'></p>
          ...
          <p className='discription'>The Index of Industrial Production (IIP) for India in February 2024 was 139.6 for mining, 144.5 for manufacturing, and 187.1 for electricity. The IIP for January 2024 was 153.0, with a 3.8% growth. The IIP for February 2024 saw a 5.7% growth, which is a four-month high. 
</p>
</div>
        </div>
        <div className='d-flex recent-data'>
